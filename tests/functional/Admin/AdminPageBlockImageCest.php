...
class AdminPageBlockImageCest
{
    ...
    public function tryListManager(FunctionalTester $I)
    {
        ...
        $I->seeCurrentUrlEquals('/admin/pages/blocks/1/images/manager');
    ...
    {
        $I->amLoggedAsAdmin();
        $I->amOnPage('/admin/pages/blocks/1/images/manager');
        $I->see('Ajouter une image', 'a');

        $I->click('Ajouter une image', 'a');
        $I->seeResponseCodeIs(HttpCode::OK);
        $I->seeCurrentUrlEquals('/admin/pages/blocks/1/images/add');
    ...
    public function tryEdit(FunctionalTester $I)
    {
        ...
        $I->click('Editer', 'a');
        $I->seeResponseCodeIs(HttpCode::OK);
        $I->seeCurrentUrlEquals('/admin/pages/blocks/images/1/edit');
